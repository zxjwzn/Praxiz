...
class SeasonStatsPayload(ModelBase):
    ...
    prize_peak: dict[str, Any] | None = Field(..., description="奖励峰值数据，当前样本为 空值。")
    individual_peak: dict[str, Any] | None = Field(..., description="个人峰值数据，当前样本为 空值。")
...
class GetUserSeasonStatsResponse(ResponseModel[SeasonStatsEnvelope]):
    """获取赛季统计响应。"""