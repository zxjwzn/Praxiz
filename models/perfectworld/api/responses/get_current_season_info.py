...
class SeasonPropagandaPointInfo(ModelBase):
    ...
    id: str = Field(..., description="点位 ID。")
    image1_url: str = Field(..., alias="image1Url", description="宣传图片 URL。")
...
class CurrentSeasonInfoResponse(GenericApiResponse[CurrentSeasonEnvelope]):
    """当前赛季信息响应。"""